  ...
  return (
    ...
    >
      ...
      <div className="content-container relative z-10 flex h-full min-h-0 flex-col justify-center">
        ...
        <div
          className="content-container-edge absolute top-1/2 z-0 h-[min(52vw,240px)] w-[min(52vw,240px)] -translate-x-[35%] -translate-y-1/2 rounded-full bg-[#1D4ED8] opacity-75 sm:h-[min(62vw,300px)] sm:w-[min(62vw,300px)] sm:-translate-x-[32%] sm:opacity-70 md:h-[min(70vw,380px)] md:w-[min(70vw,380px)] md:-translate-x-[28%]"
          aria-hidden
        />
        <div
          key={index}
        ...
        >
          ...
          <div className="flex flex-col gap-3 pt-2 xs:flex-row xs:flex-wrap xs:items-center xs:gap-4">
            ...
            <div className="flex items-center gap-2 xs:gap-3">
              <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#1D4ED8] xs:h-12 xs:w-12">
                <Headphones
      ...
      <div className="pointer-events-none absolute inset-0 z-0 isolate flex items-end justify-end overflow-hidden">
        <div
          className="slider-shape-circle absolute bottom-[8%] right-[10%] z-1 h-0 w-0 rounded-full bg-[#FC60AF] opacity-0 sm:block sm:h-[min(18vw,100px)] sm:w-[min(18vw,100px)] sm:opacity-100 md:h-[min(22vw,140px)] md:w-[min(22vw,140px)]"
          aria-hidden
        />
        <div
