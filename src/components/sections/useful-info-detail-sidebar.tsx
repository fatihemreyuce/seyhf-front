...
interface UsefulInfoDetailSidebarProps {
  items: UsefulInformationResponse[];
  basePath?: string;
}

export function UsefulInfoDetailSidebar({
  items,
  basePath = "",
}: UsefulInfoDetailSidebarProps) {
  ...
  const filteredItems = animatedItems;
        ...
        <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
          ...
          <div className="p-5">
            <div className="relative">
              <input
                id="useful-info-detail-sidebar-search"
                type="search"
              ...
              />
              <label
                htmlFor="useful-info-detail-sidebar-search"
