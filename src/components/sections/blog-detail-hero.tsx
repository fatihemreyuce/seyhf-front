...
/** Blog detay sayfası hero — 4. SS mantığı: gri zemin, kırmızı eğri, kesikli daireler, sağ üst koyu şekil, ortada başlık + breadcrumb */
...
export function BlogDetailHero({ title, basePath = "" }: BlogDetailHeroProps) {
  ...
  return (
    ...
    >
      ...
      {/* İçerik: ortada başlık + breadcrumb */}
      <div className="content-container relative z-10 flex min-h-[260px] flex-col items-center justify-center text-center md:min-h-[320px] lg:min-h-[360px]">
        ...
        >
          ...
          <span className="opacity-95" aria-current="page">
            {title}
          </span>
        </nav>
      </div>
